...
1. 列表页/详情页标题栏随滚动自动隐藏与显示。
2. 登录成功后自动跳转时隐藏中间提示页，避免闪屏。
3. 详情页图片改为满宽显示，阅读体验更接近原帖。

## 最近更新 (2026-02-22)

1. 优化载入速度：详情页采用两阶段解析与缓存渲染，提升首屏加载体验。
2. 增加收藏与字体调整按钮：详情页可一键收藏并动态调整帖子字体大小。
3. 增加跳转链接与复制功能：正文链接可点击跳转，文字支持长按选中复制。
